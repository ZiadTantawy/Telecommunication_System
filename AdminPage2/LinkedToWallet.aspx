<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LinkedToWallet.aspx.cs" Inherits="Telecommunication_System.AdminPage2.LinkedToWallet" %>

<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
    <title>Linked to Wallet</title>
    <style>
        body {
...
<body>
    <form id="form1" runat="server">
        <div class="header">
            <h1>Check Wallet Linked to Mobile Number</h1>
        </div>
        ...
        <div class="container">
            ...
            <!-- Check Button -->
            <asp:Button ID="btnCheck" runat="server" Text="Check Wallet Link" OnClick="btnCheck_Click" CssClass="button" />
