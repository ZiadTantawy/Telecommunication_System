...
{
    public partial class ViewAccountPaymentsDetails : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                LoadAccountPaymentsDetails();
            }
        }

        // Function to load account payment details from the database
        private void LoadAccountPaymentsDetails()
        {
            ...
            try
            {
                using (SqlConnection conn = new SqlConnection(connectionString))
                {
                    ...
                    {
                        tblAccountPaymentsDetails.Rows.Clear();  // Clear previous data from the table
                        ...
                        tblAccountPaymentsDetails.Rows.Add(headerRow);
                        ...
                        while (reader.Read())
                        {
                            ...
                            tblAccountPaymentsDetails.Rows.Add(dataRow);
                        }
                    }
                }
            }
