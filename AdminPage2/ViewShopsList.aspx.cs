...
{
    public partial class ViewEshopVoucherDetails : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                LoadEshopVoucherDetails();
            }
        }

        // Function to load E-shop voucher details from the database
        private void LoadEshopVoucherDetails()
        {
            ...
            try
            {
                using (SqlConnection conn = new SqlConnection(connectionString))
                {
                    ...
                    {
                        tblEshopVoucherDetails.Rows.Clear();  // Clear previous data from the table
                        ...
                        tblEshopVoucherDetails.Rows.Add(headerRow);
                        ...
                        while (reader.Read())
                        {
                            ...
                            tblEshopVoucherDetails.Rows.Add(dataRow);
                        }
                    }
                }
            }
