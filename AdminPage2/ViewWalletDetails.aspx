<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ViewWalletDetails.aspx.cs" Inherits="Telecommunication_System.ViewWalletDetails" %>
...
<body>
    <form id="form1" runat="server">
        <h1>View Wallet Details</h1>
        <div>
            <asp:Label ID="lblMessage" runat="server" CssClass="message"></asp:Label>
            <!-- Table for displaying wallet details -->
            <asp:Table ID="tblWalletDetails" runat="server" CssClass="wallet-table">
            </asp:Table>
